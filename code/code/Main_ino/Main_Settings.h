...
const long POSITION_A = -5000; 			  		// depositing location A
const long POSITION_B = -6000;						// depositing location B
...
const float minPulse = 1000;					// min pulse for motor (1000, 2000)
const float maxPulse = 2000;					// max pulse for motor (1000, 2000)
